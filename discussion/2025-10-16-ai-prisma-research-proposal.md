...
1. **Dual Research Objectives**:
   - Literature Review: Comprehensive systematic review demonstrating ResearcherRAG methodology
...
**Goal**: Conduct a high-quality systematic review using ResearcherRAG, publishable in top-tier journals
...
**Workflow**:
1. ResearcherRAG extracts metadata (DOI, title, authors)
...
5. Uploads PDFs to ResearcherRAG workspace
...
**Process**:
1. Publish ResearcherRAG systematic review + all materials
...
├── README.md (overview)
├── config.yaml (exact ResearcherRAG configuration)
├── prompts/
...
### Tools Used
We used ResearcherRAG v2.0 (You, 2025), an open-source AI-assisted
...
- Meta-analysis of 3-5 systematic reviews conducted with ResearcherRAG
...
- **Parallel Review Design**:
  ...
  - Team B: AI-assisted review (ResearcherRAG)
  - Compare:
    - Time to completion
    - Cost
...
**Objective**: Establish ResearcherRAG as standard tool
...
3. **Journal Outreach**:
   ...
   - Submit "Registered Reports" using ResearcherRAG (pre-acceptance)
...
**Success Metrics**:
- 100+ published studies using ResearcherRAG (within 3 years)
- 5+ journals adopt AI disclosure guidelines
- ResearcherRAG cited 500+ times
...
**Blog Series** (ResearcherRAG website):
...
3. **Research Libraries**:
   ...
   - Train librarians in ResearcherRAG
...
- ✅ Release ResearcherRAG v2.0 (community feedback)
...
- ✅ 50+ GitHub stars for ResearcherRAG
...
- ✅ 500+ citations
- ✅ 100+ published studies using ResearcherRAG
...
**AI-Assisted Review (ResearcherRAG)**:
- Time: 3-6 weeks
