    ...
    <GuideLayout>
      <div className="max-w-4xl">
        ...
        <p className="text-gray-700 mb-10 text-lg leading-relaxed">
          ...
          of ScholaRAG in simple, non-technical language.
        </p>
        ...
        <section className="mb-16 border-b border-gray-200 pb-16">
          ...
          <p className="text-gray-700 leading-relaxed">
            In ScholaRAG, we have <strong>7 scripts</strong> (named{' '}
        ...
        <section className="mb-16 border-b border-gray-200 pb-16">
          ...
          <div className="bg-gray-100 border border-gray-300 p-5 rounded-lg">
            <p className="text-sm text-gray-800 mb-2">
              <strong>💡 For ScholaRAG users:</strong>
            </p>
            <p className="text-sm text-gray-700">
              You don't need to learn Python deeply! ScholaRAG scripts are already written.
        ...
        <section className="mb-16 border-b border-gray-200 pb-16">
          ...
          <div className="bg-gray-50 border border-gray-300 p-6 rounded-lg mb-6">
            <p className="font-semibold mb-3 text-gray-900">Common Terminal commands for ScholaRAG:</p>
        ...
        <section className="mb-16">
          ...
          <div className="bg-gray-100 border border-gray-300 p-5 rounded-lg">
            ...
            <p className="text-sm text-gray-700">
              ScholaRAG automates the PRISMA workflow! Scripts 01-03 handle Identification, Screening, and Eligibility.
