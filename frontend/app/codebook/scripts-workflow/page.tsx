      ...
      <div className="max-w-4xl">
        ...
        <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6 mb-10">
          ...
          <p className="text-gray-700 mb-3 leading-relaxed">
            ScholaRAG's scripts MUST run in order (01 → 02 → 03 → 04 → 05 → 06 → 07) because each script
        ...
        <div className="bg-white border-2 border-gray-300 p-6 rounded-lg mb-12 overflow-x-auto">
          <p className="text-sm text-gray-600 mb-4 font-semibold">Complete ScholaRAG Pipeline:</p>
