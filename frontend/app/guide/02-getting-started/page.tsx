  ...
  return (
    <GuideLayout>
      ...
      <p className="text-xl text-muted mt-6 mb-8">
        Set up ResearcherRAG in 30 minutes. Install prerequisites, clone the repository, and start your first systematic literature review workflow.
      </p>
      ...
      <p>ResearcherRAG works best with Claude Code. Here's how to install and set it up:</p>
      ...
      <h2 id="setup">Step 2: Setup ResearcherRAG</h2>
...
code .`}
      ...
      <ol className="space-y-2 my-6">
        ...
        <li><strong>2. Copy Stage 1 Prompt</strong>: Open <code>prompts/01_research_domain_setup.md</code> in the ResearcherRAG root folder</li>
...
# Should show: Your created project`}
      ...
      <div className="border-2 border-gray-900 rounded-lg p-6 bg-gray-50 my-6">
        ...
        <CodeBlock
          language="text"
          code={`Please set up ResearcherRAG for me automatically:
...
6. Initialize a new project: python researcherrag_cli.py init
7. Verify setup: python researcherrag_cli.py --help
...
Execute these steps one by one and let me know if any issues occur.`}
      ...
      <p>
        Now that ResearcherRAG is set up, learn about the underlying concepts: <Link href="/guide/03-core-concepts" className="underline">Chapter 3: Core Concepts</Link>.
      </p>
