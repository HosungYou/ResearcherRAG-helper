    ...
    style H fill:#bbf7d0
      ...
      <div className="callout">
        ...
        <ul className="text-sm space-y-1 ml-4 mb-2">
          <li><strong>Claude Sonnet 4.5</strong> (Oct 2024): Currently the most effective coding model for research automation, achieving state-of-the-art performance on SWE-bench</li>
